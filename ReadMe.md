...
4. Введите данные для задчи, например:
    ...
    ```
5. Нажмите `Send`. Если задача успешно создана, вы получите JSON с данными.
6. Пример вывода:
    ```json
    {
        "title": "Docker task",
...
### Шаг 5: Получение списка задач по статусу
